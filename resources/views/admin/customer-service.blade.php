<x-admin-layout :user="$user" :userrole="$userRole">
    <div class="py-12">
        <div class=" flex gap-10 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg flex-[2]">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="mb-4 flex items-center justify-between gap-20">
                        <h1 class="font-bold text-neutral-700">Customer Service</h1>
            ...
            <div class="flex-1">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-8">
                    ...
                    <p class="text-sm text-gray-500">Total Queries: 8</p>
                    <p class="text-sm text-gray-500">Resolved Queries: 5</p>
                    <p class="text-sm text-gray-500">Pending Queries: 3</p>
                </div>
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-8 mt-6">
                    <h2 class="text-lg font-semibold text-gray-700">Recent Queries</h2>
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-8 mt-6">
                    <h2 class="text-lg font-semibold text-gray-700">Query Statistics</h2>
