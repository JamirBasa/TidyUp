<x-admin-layout :user="$user" :userrole="$userRole">
    ...
    <div class="grid grid-cols-2 gap-4 mb-4">
        <div class="bg-white px-7 py-7 rounded-lg shadow-sm relative">
            <img class="absolute top-7 right-7" src="img/Icons/Arrow/Arrow_Up_Right_MD.svg" alt="icon">
            <h6>Revenue</h6>
            <h1 class="text-4xl font-bold mb-3">&#8369;20,400.00</h1>
            <div class="relative flex items-center">
                <img class="absolute" src="img/Icons/Arrow/Caret_Down_MD.svg" alt="">
            ...
            <div class="w-full p-4 bg-white">
                <svg viewBox="0 0 600 300" class="w-full h-auto">
                    ...
                    <!-- Line chart -->
                    <path d="M 40 260 L 130 100 L 220 180 L 310 160 L 400 140 L 490 120 L 560 40"
                        class="stroke-brand-500 stroke-2 fill-none" />

                    <!-- Data points -->
                    <circle cx="40" cy="260" r="3" class="fill-brand-500" />
                    <circle cx="130" cy="100" r="3" class="fill-brand-500" />
                    <circle cx="220" cy="180" r="3" class="fill-brand-500" />
                    <circle cx="310" cy="160" r="3" class="fill-brand-500" />
                    <circle cx="400" cy="140" r="3" class="fill-brand-500" />
                    <circle cx="490" cy="120" r="3" class="fill-brand-500" />
                    <circle cx="560" cy="40" r="3" class="fill-brand-500" />
        ...
        <div class="bg-white px-7 py-7 rounded-lg shadow-sm relative">
            ...
            <!-- analytics -->
            <div class="w-full p-4 bg-white">
                <svg viewBox="0 0 580 300" class="w-full h-auto">
                    <!-- Grid lines -->
                    <line x1="40" y1="40" x2="560" y2="40" class="stroke-gray-200" />
                    <line x1="40" y1="80" x2="560" y2="80" class="stroke-gray-200" />
                    <line x1="40" y1="120" x2="560" y2="120" class="stroke-gray-200" />
        ...
        <div class="bg-white px-7 py-7 rounded-lg shadow-sm">
            <div class="flex items-center justify-between mb-10">
                <div class="flex items-center gap-2">
                    <img class="mt-2" src="img/Icons/Arrow/Arrow_Up_Right_MD.svg" alt="icon">
                    <h2 class="text-4xl font-semibold">Customers</h2>
                </div>
                <button class="flex items-center gap-3">
                    <img src="img/Icons/Arrow/Arrow_Down_Up.svg" alt="">
                    <span>Sort by</span>
                </button>
            </div>
