@php
    $rows = [
        ...
        [
            'transaction_id' => '741037025',
            'services' => 'Nail Salon Service',
            'customer' => 'Jane Doe',
            'vat_no' => '87956622',
            'date' => '10 Oct, 2024',
            'time' => '12:00 PM',
        ...
        [
            'transaction_id' => '741037026',
            'services' => 'Beauty Salon Service',
            'customer' => 'John Smith',
            'vat_no' => '87956623',
            'date' => '11 Oct, 2024',
            'time' => '01:00 PM',
        ...
        [
            'transaction_id' => '741037029',
            'services' => 'Manicure Service',
        ...
        [
            'transaction_id' => '741037030',
            'services' => 'Pedicure Service',
            'customer' => 'David Lee',
            'vat_no' => '87956627',
            'date' => '15 Oct, 2024',
            'time' => '05:00 PM',
...
<x-admin-layout :user="$user" :userrole="$userRole">
            ...
            <table class="min-w-full divide-y divide-gray-200 rounded-lg overflow-hidden shadow">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($rows as $row)
                        ...
                        @endphp
                        <tr id="row{{ $index }}"
                            class="hover:bg-neutral-50 cursor-pointer transistion-color duratio ease-in-out">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div
                                    class="text-xs  font-bold  p-1 grid place-items-center rounded-full {{ $class }}">
                                    {{ $row['status'] }}
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
    ...
    <div id="sales-report-popover"
        ...
        <div id="sales-report-popover-content"
            ...
            <div>
                <h6 class="font-bold text-4xl">Invoice</h6>
