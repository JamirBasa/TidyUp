            ...
            <div class="pt-20 px-36">
                ...
                <form action="" method="POST">
                    ...
                    <div class="flex flex-col gap-2 mb-8">
                        <label class="text-left font-semibold " for="email">Email Adress</label>
                        <input class="border border-neutral-300 py-3 px-6 rounded-lg" type="text" placeholder="Email Address">
                    </div>

                    {{-- password --}}
                    <div class="flex flex-col gap-2 mb-8">
                        <label class="text-left font-semibold " for="password">Password</label>
                        <div class="flex-1 flex relative items-center">
                            <input id="password" class="flex-1 border border-neutral-300 py-3 px-6 rounded-lg" type="password" placeholder="Password">
                            {{-- Hide Icon --}}
                            ...
                            {{-- Show Icon --}}
                            <svg id="show-icon" class="stroke-neutral-300 absolute right-5 cursor-pointer hidden" width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="w-full flex justify-center gap-2">
                    ...
                    <a href="{{ route('shop.registration') }}">
