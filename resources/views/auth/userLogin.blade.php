...
<body>
    <main class="min-h-screen bg-white lg:bg-transparent">
        <section class="flex flex-col lg:grid lg:grid-cols-2 relative">
            ...
            <img class="hidden lg:block h-screen object-cover col-span-1" 
                 src="{{ asset('assets/images/signUpBG.png') }}" alt="">
    
            {{-- Form Container --}}
            <div class="px-4 pt-8 md:px-12 lg:pt-16 lg:px-10 2xl:px-32">
                {{-- Logo --}}
                <a href="{{ route('index') }}" class="flex justify-center">
                    <img class="w-16 h-16 lg:w-24 lg:h-24 mb-4" 
                         src="{{ asset('assets/images/tidyUpLogo.svg') }}" alt="logo">
                </a>
                
                <h1 class="font-clash font-medium text-2xl lg:text-4xl mb-2 lg:mb-4 text-center">Welcome to TidyUp!</h1>
                <p class="text-neutral-600 text-sm lg:text-base mb-6 lg:mb-4 text-center">We are glad to have you here.</p>
                ...
                <form action="{{ route('user.login') }}" method="POST" class="mb-6">
                    ...
                    <div class="flex flex-col gap-2 mb-6 lg:mb-8">
                        <div class="inline-flex items-center gap-3">
                            <label class="text-left font-semibold text-sm lg:text-base" for="email">Email Address</label>
                            
                        </div>
                        <input class="w-full border border-neutral-300 py-2.5 lg:py-3 px-4 lg:px-6 rounded-lg text-sm lg:text-base" 
                ...
                <button class="w-full border border-neutral-300 rounded-lg p-2.5 lg:p-3 flex items-center gap-3 justify-center mb-4 lg:mb-6 hover:border-brand-500 text-sm lg:text-base">
                    <img class="w-5 h-5 lg:w-7 lg:h-7" src="{{ asset('assets/images/googlelogo.svg') }}" alt="google">
                    <span>Continue with Google</span>
                </button>
    
                <button class="w-full border border-neutral-300 rounded-lg p-2.5 lg:p-3 flex items-center gap-3 justify-center mb-4 lg:mb-6 hover:border-brand-500 text-sm lg:text-base">
                    <img class="w-5 h-5 lg:w-7 lg:h-7" src="{{ asset('assets/images/facebooklogo.svg') }}" alt="facebook">
            ...
            <a class="hidden lg:flex items-center absolute top-8 left-8" href="{{ url()->previous() }}">
                <svg class="w-5 h-5 lg:w-7 lg:h-7" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
