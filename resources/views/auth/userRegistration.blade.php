        ...
        <div class="max-w-screen-xl mx-auto bg-white py-20 px-28 rounded-lg mt-28 ">
            ...
            <div class="flex flex-col gap-3 mb-12 flex-1">
                ...
                <div class="flex-1 flex relative items-center">
                    <input class="border w-full border-neutral-400 py-3 px-4 rounded-lg" type="password" name="password_confirmation" id="password_confirmation" placeholder="Confirm your password">
