...
<body>
    <main class="px-4 pb-8 md:pb-20">
        ...
        {{-- Form Container --}}
        <div class="w-full max-w-screen-xl mx-auto bg-white py-8 px-8 rounded-lg mt-4 
                    md:py-12 md:px-16 lg:py-20 lg:px-28 lg:mt-28">
            ...
            <form action="" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-6 md:mb-8">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <input class="border border-neutral-400 py-3 px-4 rounded-lg w-full @error('first_name') ring-1 ring-red-500 @enderror" 
                    ...
                    <div class="flex flex-col gap-3"> 
                        ...
                        <input class="border border-neutral-400 py-3 px-4 rounded-lg w-full @error('last_name') ring-1 ring-red-500 @enderror" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-6 md:mb-8">
                    ...
                    <div class="flex flex-col gap-3"> 
                        ...
                        <input class="border border-neutral-400 py-3 px-4 rounded-lg w-full @error('username') ring-1 ring-red-500 @enderror" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-6 md:mb-8">
                    ...
                    <div class="flex flex-col gap-3 md:col-span-2">
                        ...
                        <input class="border border-neutral-400 py-3 px-4 rounded-lg w-full @error('email') ring-1 ring-red-500 @enderror" 
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <input class="border border-neutral-400 py-3 px-4 rounded-lg w-full @error('phone_num') ring-1 ring-red-500 @enderror" 
                               type="tel" inputmode="numeric" name="phone_num" id="phone_num" 
                               placeholder="XXXX-XXX-XXXX" value="{{ old('phone_num') }}">
                        @error('phone_num')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="flex flex-col mb-6 md:mb-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <div class="relative flex items-center">
                                <select class="border w-full border-neutral-400 py-3 px-4 rounded-lg appearance-none @error('region') ring-1 ring-red-500 @enderror" 
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <input class="border border-neutral-400 py-3 px-4 rounded-lg @error('detailed_address') ring-1 ring-red-500 @enderror" 
                ...
                <div class="flex flex-col gap-3 mb-8">
                    ...
                    <div class="relative flex items-center">
                        <input class="border w-full border-neutral-400 py-3 px-4 rounded-lg" 
