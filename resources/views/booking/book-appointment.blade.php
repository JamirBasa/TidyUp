    ...
    <section>
        ...
        <div class="grid grid-cols-7 gap-10">
            ...
            <div class="col-span-5 ">
                <div class="mb-4">
                    <h1 class="text-2xl">Choose an appointment option</h1>
                </div>
                <div class="grid gap-4">
                    <a href="{{ route('book-appointment2') }}">
                        <div
                            ...
                            <div>
                                <svg class="stroke-2 stroke-neutral-400 size-20 group-hover:stroke-neutral-700 transition-colors ease-in-out"
                            ...
                            <div class="space-y-2">
                                <h1 class="text-xl">Solo Appointment</h1>
                                <p class="text-sm">Book an appointment for yourself only</p>
                            </div>
                        </div>
                    </a>
                    <a href="{{ route('book-appointment2') }}">
                        <div
                            ...
                            <div class="space-y-2">
                                <h1 class="text-xl">Multiple Appointment</h1>
                                <p class="text-sm">Book an appointment for a max of 4 people</p>
                            </div>
                        </div>
                    </a>
                    <a href="{{ route('book-appointment2') }}">
                        <div
                            ...
                            <div class="space-y-2">
                                <h1 class="text-xl">Bulk Appointment</h1>
                                <p class="text-sm">Book an appointment for a huge amount of people</p>
                            </div>
                        </div>
                    </a>
                </div>
