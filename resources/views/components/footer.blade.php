...
<div class="w-full py-20 flex items-center justify-center">
    <div
        ...
        <div class="flex mt-8 flex-col md:flex-row md:justify-between ">
            <p class="w-full md:w-2/3 2xl:m text-gray-400">
                Discover the best salon and barbershop services with TidyUp. Book appointments, reserve your spot, and
                browse for shops easily. Our platform connects you with top-rated professionals, ensuring you receive
                the highest quality service.
            </p>
            <button class="w-44 pt-6 md:pt-0">
                <a
                    class="bg-brand-500 text-white justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">Contact
                    US
                </a>
            </button>
        </div>
        <div class="flex flex-col">
            <div class="flex mt-24 mb-12 flex-row justify-between items-center">
                <div class="inline-flex items-center gap-3">
                    <img src="{{ asset('assets/images/tidyUpLogo.svg') }}" alt="logo" class="w-24" />
                    <h1 class="font-clash font-medium text-4xl">TidyUp</h1>
                </div>
            ...
            <p class="w-full text-center my-12 text-gray-600">Copyright © 2024 TidyUp, Pristeam</p>
        </div>
    </div>
</div>
