@if(!session('visited'))
    <div id="loading-screen" class="transition-opacity duration-1000 ease-in-out fixed top-0 right-0 left-0 bottom-0 bg-milk z-50 flex flex-col items-center pt-96">
