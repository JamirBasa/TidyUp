    ...
    <nav class=" flex items-center  justify-between px-6">
        ...
        <div class="flex items-center gap-4">
            <button class="" onclick="toggleSidebar()">
                <img id="sidebar-toggle" class="size-9" src="{{ asset('assets/Icons/Menu/Menu_Alt_04.svg') }}"
                    alt="">
            </button>
        ...
        <div class="flex items-center justify-between gap-16">
            ...
            <div class="flex items-center justify-between gap-6">
                ...
                <button class="relative bg-neutral-150 rounded-full size-12 shadow-sm">
                    <img class="absolute top-[0.60rem] right-[0.55rem]"
                        src="{{ asset('assets/Icons/Communication/Bell_Notification.svg') }}" alt="">
                </button>
                <!-- profile picture -->
                <div id="user-profile" class="shadow-sm rounded-full relative cursor-pointer">
                    <div class="size-12">
                        <x-user-profile-pic />
                    </div>
