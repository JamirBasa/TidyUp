    ...
    <nav class="">
        ...
        {{-- Appoinments --}}
            <li class="flex px-4 py-2 w-full relative rounded-lg overflow-hidden">
                <a href="" class="flex items-center gap-5">
                    ...
                    <p id="sidebar-link-name" class="font-poppins font-normal text-nowrap opacity-0 transition-opacity duration-300 ease-in-out hidden">Appoinments</p>
                </a>
            </li>
        {{-- Shop Profile --}}
            <li class="flex px-4 py-2 w-full relative rounded-lg overflow-hidden">
        ...
        {{-- Manage Branches --}}
            <li class="flex px-4 py-2 w-full relative rounded-lg overflow-hidden">
                <a href="" class="flex items-center gap-5">
                    <svg class="size-7 stroke-[1.5] stroke-black" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M15 11.0006L11 15.0006L9 13.0006M4 16.8007V11.4527C4 10.9184 4 10.6511 4.06497 10.4024C4.12255 10.1821 4.21779 9.97356 4.3457 9.78513C4.49004 9.5725 4.69064 9.39618 5.09277 9.04432L9.89436 4.84292C10.6398 4.19063 11.0126 3.86446 11.4324 3.74031C11.8026 3.63083 12.1972 3.63083 12.5674 3.74031C12.9875 3.86455 13.3608 4.19103 14.1074 4.84431L18.9074 9.04431C19.3096 9.39618 19.5102 9.5725 19.6546 9.78513C19.7825 9.97356 19.877 10.1821 19.9346 10.4024C19.9995 10.6511 20 10.9184 20 11.4527V16.8041C20 17.9221 20 18.4816 19.7822 18.909C19.5905 19.2854 19.2837 19.591 18.9074 19.7828C18.48 20.0006 17.921 20.0006 16.8031 20.0006H7.19691C6.07899 20.0006 5.5192 20.0006 5.0918 19.7828C4.71547 19.591 4.40973 19.2854 4.21799 18.909C4 18.4812 4 17.9208 4 16.8007Z" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <p id="sidebar-link-name" class="font-poppins font-normal text-nowrap opacity-0 transition-opacity duration-300 ease-in-out hidden">Manage Branches</p>
                </a>
            </li>
        ...
        <div class="flex-grow border-t border-neutral-400 w-full"></div>
         {{-- Analytics  --}}
            <li class="flex px-4 py-2 w-full relative rounded-lg overflow-hidden">
                <a href="" class="flex items-center gap-5">
                    <svg class="size-7 stroke-[1.5] stroke-black" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21C16.9706 21 21 16.9706 21 12M12 3C16.9706 3 21 7.02944 21 12M12 3V12M21 12H12M18 18.5L12 12" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
        ...
        {{-- Shop Sales --}}
            <li class="flex px-4 py-2 w-full relative rounded-lg overflow-hidden">
                <a href="" class="flex items-center gap-5">
                    <svg class="size-7 stroke-[1.5] stroke-black" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M4.74693 7.64551L4.41571 11.289C4.36665 11.8286 4.34192 12.1006 4.38682 12.3589C4.42695 12.5896 4.50708 12.8117 4.62398 13.0147C4.75532 13.2427 4.94945 13.4368 5.33549 13.8228L10.511 18.9983C11.298 19.7854 11.6918 20.1791 12.147 20.327C12.5487 20.4575 12.9821 20.4578 13.3837 20.3273C13.8404 20.1789 14.2372 19.7826 15.0293 18.9906L18.9891 15.0308C19.7811 14.2387 20.1765 13.8429 20.3248 13.3862C20.4553 12.9845 20.4546 12.5516 20.324 12.15C20.1757 11.6933 19.7809 11.2975 18.9889 10.5055L13.8261 5.34278C13.4366 4.95321 13.2417 4.75841 13.0127 4.62647C12.8097 4.50957 12.5876 4.42909 12.3569 4.38897C12.0965 4.34368 11.822 4.36858 11.2733 4.41846L7.64351 4.74844C6.69875 4.83433 6.22608 4.87746 5.8564 5.08303C5.53048 5.26428 5.26179 5.53296 5.08055 5.85889C4.876 6.22672 4.83334 6.69604 4.74831 7.6314L4.74693 7.64551Z"  stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M9.71161 9.71346C10.1021 9.32293 10.1021 8.68977 9.71161 8.29924C9.32109 7.90872 8.68747 7.90872 8.29695 8.29924C7.90642 8.68977 7.90605 9.32278 8.29657 9.71331C8.6871 10.1038 9.32109 10.104 9.71161 9.71346Z" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    <p id="sidebar-link-name" class="font-poppins font-normal text-nowrap opacity-0 transition-opacity duration-300 ease-in-out hidden">Shop Sales</p>
                </a>
            </li>
        {{-- Shop Reviews --}}
            <li class="flex px-4 py-2 w-full relative rounded-lg overflow-hidden">
                <a href="" class="flex items-center gap-5">
                    <svg class="size-7 stroke-[1.5] stroke-black" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M15 10L11 14L9 12M12.0001 21C10.365 21 8.83174 20.5639 7.51025 19.8018C7.3797 19.7265 7.31434 19.6888 7.25293 19.6719C7.19578 19.6561 7.14475 19.6507 7.08559 19.6548C7.02253 19.6591 6.9573 19.6808 6.82759 19.7241L4.51807 20.4939L4.51625 20.4947C4.02892 20.6572 3.7848 20.7386 3.62256 20.6807C3.4812 20.6303 3.36979 20.5187 3.31938 20.3774C3.26157 20.2152 3.34268 19.9719 3.50489 19.4853L3.50586 19.4823L4.27468 17.1758L4.27651 17.171C4.31936 17.0424 4.34106 16.9773 4.34535 16.9146C4.3494 16.8554 4.34401 16.804 4.32821 16.7469C4.31146 16.6863 4.27448 16.6221 4.20114 16.495L4.19819 16.4899C3.43604 15.1684 3 13.6351 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12C21 16.9706 16.9707 21 12.0001 21Z"  stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <p id="sidebar-link-name" class="font-poppins font-normal text-nowrap opacity-0 transition-opacity duration-300 ease-in-out hidden">Shop Reviews</p>
                </a>
            </li>
        {{-- Separator --}}
        <div class="flex-grow border-t border-neutral-400 w-full"></div>
        ...
        <!-- Send Feedback -->
            <li class="flex px-4 py-2 w-full relative rounded-lg overflow-hidden">
                <a href="" class="flex items-center gap-5">
                    <svg class="size-7 stroke-[1.5] stroke-black" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M4 6L10.1076 10.6123L10.1097 10.614C10.7878 11.1113 11.1271 11.3601 11.4988 11.4562C11.8272 11.5412 12.1725 11.5412 12.501 11.4562C12.8729 11.36 13.2132 11.1105 13.8926 10.6123C13.8926 10.6123 17.8101 7.60594 20 6M3 15.8002V8.2002C3 7.08009 3 6.51962 3.21799 6.0918C3.40973 5.71547 3.71547 5.40973 4.0918 5.21799C4.51962 5 5.08009 5 6.2002 5H17.8002C18.9203 5 19.4796 5 19.9074 5.21799C20.2837 5.40973 20.5905 5.71547 20.7822 6.0918C21 6.5192 21 7.07899 21 8.19691V15.8036C21 16.9215 21 17.4805 20.7822 17.9079C20.5905 18.2842 20.2837 18.5905 19.9074 18.7822C19.48 19 18.921 19 17.8031 19H6.19691C5.07899 19 4.5192 19 4.0918 18.7822C3.71547 18.5905 3.40973 18.2842 3.21799 17.9079C3 17.4801 3 16.9203 3 15.8002Z" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <p id="sidebar-link-name" class="font-poppins font-normal text-nowrap opacity-0 transition-opacity duration-300 ease-in-out hidden">Send Feedback</p>
                </a>
            </li>
        <!-- Report An Issue -->
            <li class="flex px-4 py-2 w-full relative rounded-lg overflow-hidden">
        ...
        <!-- About Us -->
            <li class="flex px-4 py-2 w-full relative rounded-lg overflow-hidden">
                <a href="" class="flex items-center gap-5">
                    ...
                    <p id="sidebar-link-name" class="font-poppins font-normal text-nowrap opacity-0 transition-opacity duration-300 ease-in-out hidden">About Us</p>
                </a>
            </li>
        </ul>
    </nav>
