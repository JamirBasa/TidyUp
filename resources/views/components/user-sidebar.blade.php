<section class="max-w-screen-2xl mx-auto ">
    <div id="user-sidebar" class="fixed w-52 pr-2 pb-8 top-28 bottom-0 gap-3 flex flex-col overflow-y-auto">
        {{-- Home --}}
        <a href="">
            <button class="inline-flex items-center gap-2 w-full py-3 px-6 rounded-lg bg-neutral-150">
        ...
        {{-- Appoinments --}}
        <a href="">
            <button class="inline-flex items-center gap-2 w-full py-3 px-6 rounded-lg">
                <svg class="stroke-black stroke-[1.5]" width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="text-sm select-none">Appoinments</span>
            </button>
        </a>
        {{-- Explore --}}
        <a href="">
