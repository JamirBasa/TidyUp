<section class="hidden lg:block" id="sidebar-container">
    <div id="user-sidebar"
        ...
        <a href="{{ route('index') }}" id="home-link" data-url="{{ route('home.content') }}"
            class="nav-link inline-flex items-center gap-2 w-full py-2 sm:py-3 px-6 rounded-lg hover:bg-neutral-150 transition-colors delay-150 ease-out">
        ...
        <a href="{{ route('explore') }}" id="explore-link" data-url="{{ route('explore.content') }}"
            class="nav-link inline-flex items-center gap-2 w-full py-2 sm:py-3 px-6 rounded-lg hover:bg-neutral-150">
            <svg class="stroke-black stroke-[1.5] size-6" width="30" height="30" viewBox="0 0 24 24"
                fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
