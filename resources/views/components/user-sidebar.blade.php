<section class="
    ...
    <div id="user-sidebar" class=" shadow-lg fixed w-64 lg:w-52 px-4 lg:px-0 lg:pr-2 pb-8 top-16 pt-10 lg:pt-0 lg:top-28 bottom-0 gap-3 flex flex-col overflow-y-auto bg-neutral-100 lg:bg-transparent lg:shadow-none z-50">
        {{-- Home --}}
        
        <a href="{{ route('index') }}" id="home-link" data-url="{{ route('home.content') }}" class="nav-link inline-flex items-center gap-2 w-full py-2 sm:py-3 px-6 rounded-lg hover:bg-neutral-150 transition-colors delay-150 ease-out">
            <svg class="stroke-black stroke-[1.5] size-6" width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {{-- Appointments --}}
        <a href="{{ route('appointments') }}" id="appointments-link" data-url="{{ route('appointments.content') }}" class="nav-link inline-flex items-center gap-2 w-full py-2 sm:py-3 px-6 rounded-lg hover:bg-neutral-150 transition-colors delay-150 ease-out ">
            <svg class="stroke-black stroke-[1.5] size-6" width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="{{ route('explore') }}" id="explore-link" data-url="{{ route('explore.content') }}" class="nav-link inline-flex items-center gap-2 w-full py-2 sm:py-3 px-6 rounded-lg hover:bg-neutral-150">
            <svg class="stroke-black stroke-[1.5] size-6" width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3 12C3 16.9706 7.02944 21 12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12Z" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <a href="" id="nav-link" class="inline-flex items-center gap-2 w-full py-2 sm:py-3 px-6 rounded-lg hover:bg-neutral-150">
            <svg class="stroke-black stroke-[1.5] size-6" width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M20.0005 7L14.1543 12.9375C14.0493 13.0441 13.9962 13.0976 13.9492 13.1396C13.1899 13.8193 12.0416 13.8193 11.2822 13.1396C11.2352 13.0976 11.1817 13.0442 11.0767 12.9375C10.9716 12.8308 10.9191 12.7774 10.8721 12.7354C10.1127 12.0557 8.96397 12.0557 8.20461 12.7354C8.15771 12.7773 8.10532 12.8305 8.00078 12.9367L4 17M20.0005 7L20 13M20.0005 7H14" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        ...
        <a href="" id="nav-link" class="inline-flex items-center gap-2 w-full py-2 sm:py-3 px-6 rounded-lg hover:bg-neutral-150">
            <svg class="stroke-black stroke-[1.5] size-6" width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3 17V15C3 10.0294 7.02944 6 12 6C16.9706 6 21 10.0294 21 15V17M6 17V15C6 11.6863 8.68629 9 12 9C15.3137 9 18 11.6863 18 15V17M9 17V15C9 13.3431 10.3431 12 12 12C13.6569 12 15 13.3431 15 15V17"  stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        ...
        <a href="" id="nav-link" class="inline-flex items-center gap-2 w-full py-2 sm:py-3 px-6 rounded-lg hover:bg-neutral-150">
            <svg class="stroke-black stroke-[1.5] size-6" width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M16.0001 13.3848C16.0001 14.6088 15.526 15.7828 14.6821 16.6483C14.203 17.1397 13.6269 17.5091 13 17.7364M19 13.6923C19 7.11538 12 2 12 2C12 2 5 7.11538 5 13.6923C5 15.6304 5.7375 17.4893 7.05025 18.8598C8.36301 20.2302 10.1436 20.9994 12.0001 20.9994C13.8566 20.9994 15.637 20.2298 16.9497 18.8594C18.2625 17.4889 19 15.6304 19 13.6923Z" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
