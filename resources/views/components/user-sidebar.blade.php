<section class="max-w-screen-2xl mx-auto ">
    <div id="user-sidebar" class="fixed w-52 pr-2 pb-8 top-28 bottom-0 gap-3 flex flex-col overflow-y-auto">
        ...
        <a href="{{ route('index') }}" id="home-link" data-url="{{ route('home.content') }}" class="nav-link inline-flex items-center gap-2 w-full py-3 px-6 rounded-lg hover:bg-neutral-150 transition-colors delay-150 ease-out">
            ...
            <span class="text-sm select-none">Home</span>
        </a>
        
        {{-- Appointments --}}
        <a href="{{ route('upcomingAp') }}" id="appointments-link" data-url="{{ route('upcomingAp.content') }}" class="nav-link inline-flex items-center gap-2 w-full py-3 px-6 rounded-lg hover:bg-neutral-150 transition-colors delay-150 ease-out ">
            <svg class="stroke-black stroke-[1.5]" width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="text-sm select-none">Appointments</span>
        </a>
        
        {{-- Explore --}}
        
        <a href="{{ route('explore') }}" id="explore-link" data-url="{{ route('explore.content') }}" class="nav-link inline-flex items-center gap-2 w-full py-3 px-6 rounded-lg hover:bg-neutral-150">
            <svg class="stroke-black stroke-[1.5]" width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="text-sm select-none">Explore</span>
        </a>
       
        {{-- Popular --}}
        
        <a href="" id="nav-link" class="inline-flex items-center gap-2 w-full py-3 px-6 rounded-lg hover:bg-neutral-150">
            <svg class="stroke-black stroke-[1.5]" width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="text-sm select-none">Popular</span>
        </a>
       
        <div class="flex-grow border-t border-gray-400"></div>

        <h1 class="py-4 px-3 font-semibold">CATEGORIES</h1>
        {{-- Barbershops --}}
        <a href="">
            <a href="" id="nav-link" class="inline-flex items-center gap-2 w-full py-3 px-6 rounded-lg hover:bg-neutral-150">
                <svg class="stroke-black stroke-[1.5]" width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="text-sm select-none">Barbershops</span>
            </a>
        </a>
        {{-- Beauty Salon --}}
        <a href="">
            <a href="" id="nav-link" class="inline-flex items-center gap-2 w-full py-3 px-6 rounded-lg hover:bg-neutral-150">
                ...
                <span class="text-sm select-none">Beauty Salon</span>
            </a>
        </a>
        {{-- Nail Salon --}}
        <a href="">
            <a href="" id="nav-link" class="inline-flex items-center gap-2 w-full py-3 px-6 rounded-lg hover:bg-neutral-150">
                ...
                <span class="text-sm select-none">Nail Salon</span>
            </a>
        </a>
        {{-- Hair Salon --}}
        <a href="">
            <a href="" id="nav-link" class="inline-flex items-center gap-2 w-full py-3 px-6 rounded-lg hover:bg-neutral-150">
                ...
                <span class="text-sm select-none">Hair Salon</span>
            </a>
        </a>
        <div class="flex-grow border-t border-gray-400"></div>
        ...
        <a href="">
            <a href="" id="nav-link" class="inline-flex items-center gap-2 w-full py-3 px-6 rounded-lg hover:bg-neutral-150">
                ...
                <span class="text-sm select-none">FAQs</span>
            </a>
        </a>
        {{-- Send Feedback --}}
        <a href="">
            <a href="" id="nav-link" class="inline-flex items-center gap-2 w-full py-3 px-6 rounded-lg hover:bg-neutral-150">
                ...
                <span class="text-sm select-none">Send Feedback</span>
            </a>
        </a>
        {{-- Report An Issue --}}
        <a href="">
            <a href="" id="nav-link" class="inline-flex items-center gap-2 w-full py-3 px-6 rounded-lg hover:bg-neutral-150">
                ...
                <span class="text-sm select-none">Report An Issue</span>
            </a>
        </a>
