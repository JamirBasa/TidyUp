<div class="border-y border-neutral-400 flex items-center justify-between py-4 px-2 mb-4">
    <div class="flex items-center gap-8 ">
        <img class="h-28 w-52 rounded-lg object-cover flex-shrink-0"
            src="{{ asset('assets/images/shops/5.png') }}" loading="lazy" alt="">
        <div class="flex flex-col gap-3">
            <p class="text-sm leading-none">Multiple Appointment</p>
            <p class="text-lg font-semibold leading-none">La Barberia de Jeco</p>
            <p class="text-sm leading-tight">Tetuan Branch, Estrada St. cor Don Toribio Tetuan, Zamboanga
                City</p>
        </div>
    </div>
