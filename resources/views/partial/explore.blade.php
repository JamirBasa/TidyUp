...
<div class="content-section">
    ...
    <div class="flex items-center justify-between mb-8">
        <h1 class="p-1 sm:p-2 font-clash font-medium text-sm sm:text-2xl border-b-2 border-black">Recommended for you
        </h1>
    ...
    <div id="carousel" class="carousel overflow-x-hidden whitespace-nowrap  snap-x mb-10 relative">
        ...
        @for ($i = 0; $i < 6; $i++)
            <a href="" id="shop-card" class="w-[21rem] sm:w-[25.6rem] inline-block mr-6 mb-8">
    ...
    <div class="grid 
        ...
        @for ($i = 0; $i < 6; $i++)
            <a href="{{ route('shop.view') }}" class="">
                <div class="relative mb-2">
                    {{-- shop image --}}
                    <img load="lazy" class="h-[13rem] smh-[13rem]:sm:h-[15rem] w-full object-cover rounded-lg"
                        src="{{ asset('assets/images/shops/' . $shops[$i]['image']) }}" alt="">
                    {{-- shop tag --}}
                    <span
                        class="absolute top-3 right-3 bg-white rounded-full py-1 px-4 text-xs sm:text-sm">{{ $shops[$i]['tag'] }}</span>
            ...
            <a href="" id="shop-card" class="w-[21rem] sm:w-[25.6rem] inline-block mr-6 mb-8">
                <div class="relative mb-2">
                    <img load="lazy" class="h-[13rem] sm:h-[15rem] w-full object-cover rounded-lg"
                        src="{{ asset('assets/images/shops/' . $shops[$i]['image']) }}" alt="">
                    <span
                        class="absolute top-3 right-3 bg-white rounded-full py-1 px-4 text-xs sm:text-sm">{{ $shops[0]['tag'] }}</span>
                </div>
                <div class="relative">
                    <h6 class="font-semibold text-sm sm:text-base">{{ $shops[$i]['name'] }}</h6>
                    <p class="opacity-60 text-xs sm:text-sm">Street Name, Barangay, City</p>
            ...
            <a href="" id="shop-card" class="w-[21rem] sm:w-[25.6rem] inline-block mr-6 mb-8">
                <div class="relative mb-2">
                    <img load="lazy" class="h-[13rem] sm:h-[15rem] w-full object-cover rounded-lg"
                        src="{{ asset('assets/images/shops/' . $shops[$i]['image']) }}" alt="">
                    <span
                        class="absolute top-3 right-3 bg-white rounded-full py-1 px-4 text-xs sm:text-sm">{{ $shops[1]['tag'] }}</span>
                </div>
                <div class="relative">
                    <h6 class="font-semibold text-sm sm:text-base">{{ $shops[$i]['name'] }}</h6>
                    <p class="opacity-60 text-xs sm:text-sm">Street Name, Barangay, City</p>
            ...
            <a href="" id="shop-card" class="w-[21rem] sm:w-[25.6rem] inline-block mr-6 mb-8">
                <div class="relative mb-2">
                    <img load="lazy" class="h-[13rem] sm:h-[15rem] w-full object-cover rounded-lg"
                        src="{{ asset('assets/images/shops/' . $shops[$i]['image']) }}" alt="">
                    <span
                        class="absolute top-3 right-3 bg-white rounded-full py-1 px-4 text-xs sm:text-sm">{{ $shops[3]['tag'] }}</span>
                </div>
                <div class="relative">
                    <h6 class="font-semibold text-sm sm:text-base">{{ $shops[$i]['name'] }}</h6>
                    <p class="opacity-60 text-xs sm:text-sm">Street Name, Barangay, City</p>
