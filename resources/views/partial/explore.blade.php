...
@endphp
    <div class="
            content-section 
            px-5 
            pt-[4rem] sm:pt-[5rem] lg:pt-32
            lg:pl-[13rem] 3xl:pl-[17rem] 
            md:pb-20  
            2xl:max-w-screen-2xl 
            lg:mx-5 3xl:px-0 3xl:mx-auto "
        > 
        ...
        <a href="" class="bg-black">
            <div class="relative lg:rounded-xl mb-10 group bg-neutral-900 -mx-5 lg:mx-0">
                <div class="relative mb-2 overflow-hidden">
                    <img load="lazy" class="h-[13rem] sm:h-[18rem] md:h-[24rem] lg:h-[32rem] w-full object-cover lg:rounded-xl" src="{{ asset('assets/images/shops/' . $shops[0]['image'] ) }}" alt="">
                    <span class="absolute top-4 md:top-6 right-4 md:right-8 bg-white rounded-full py-1 px-3 md:px-4 text-xs md:text-sm shadow-md">{{ $shops[0]['tag'] }}</span>
                </div>
                <div class="absolute bottom-0 right-0 left-0 bg-gradient-to-t from-black to-transparent lg:rounded-b-xl">
                    ...
                    <h6 class="text-lg md:text-2xl lg:text-3xl text-white font-semibold group-hover:underline">{{ $shops[0]['name'] }}</h6>
                    <span class="absolute inline-flex items-center gap-1 md:gap-2 bottom-0 p-4 md:p-8 right-0">
                        ...
                        <svg class="stroke-white stroke-1 size-4 md:size-5 fill-white" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">    
        ...
        <div class="flex items-center justify-between mb-8">
            <h1 class="p-1 sm:p-2 font-clash font-medium text-sm sm:text-2xl border-b-2 border-black">Recommended for you</h1>
            <div class="inline-flex items-center gap-2">
                <button id="left-arrow" class="inline-flex justify-center items-center">
                    <svg class="bg-white p-1 stroke-black stroke-2 size-6 sm:size-8 rounded-full shadow-md hover:shadow-md hover:scale-110 transition-transform duration-300 ease-in-out" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17 12H7M7 12L11 16M7 12L11 8" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </button>
                <button id="right-arrow" class="inline-flex justify-center items-center">
                    <svg class="bg-white p-1 stroke-black stroke-2 size-6 sm:size-8 rounded-full shadow-md hover:scale-110 transition-transform duration-300 ease-in-out" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div id="carousel" class="carousel overflow-x-hidden whitespace-nowrap snap-x mb-10">
            @for ($i = 0; $i < 6; $i++)
            <a href="" id="shop-card" class="w-[21rem] sm:w-[25.1rem] inline-block mr-6 mb-8">
                ...
                <div class="relative">
                    ...
                    <span class="absolute inline-flex items-center gap-2 top-0 right-0">
                        ...
                        <svg class="stroke-black stroke-1 size-2 sm:size-3 fill-black" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2.33301 10.3363C2.01976 10.0466 2.18992 9.5229 2.61361 9.47267L8.61719 8.76058C8.78987 8.7401 8.93986 8.63166 9.0127 8.47376L11.5449 2.98397C11.7236 2.59654 12.2744 2.59646 12.4531 2.9839L14.9854 8.47365C15.0582 8.63155 15.2072 8.74028 15.3799 8.76075L21.3838 9.47267C21.8075 9.5229 21.9772 10.0468 21.6639 10.3364L17.2258 14.4414C17.0981 14.5595 17.0413 14.7352 17.0752 14.9058L18.2531 20.8355C18.3362 21.2539 17.8908 21.5782 17.5185 21.3698L12.2432 18.4161C12.0915 18.3312 11.9071 18.3316 11.7554 18.4165L6.47949 21.369C6.10718 21.5774 5.66099 21.2539 5.74414 20.8354L6.92219 14.9061C6.95608 14.7356 6.89938 14.5594 6.77172 14.4414L2.33301 10.3363Z" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </span>
                </div>
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="" class="inline-flex items-center gap-1 sm:gap-2 p-1 sm:p-2 border-b-2 border-neutral-400">
                <svg class="stroke-neutral-500 stroke-1 size-4 sm:size-6" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="grid 
            ...
            @for ($i = 0; $i < 6; $i++)
                <a href="{{ route('shop.view') }}" class="">
                    <div class="relative mb-2">
                        {{-- shop image --}}
                        <img load="lazy" class="h-[13rem] smh-[13rem]:sm:h-[15rem] w-full object-cover rounded-lg" src="{{ asset('assets/images/shops/' . $shops[$i]['image']) }}" alt="">
                        {{-- shop tag --}}
                        <span class="absolute top-3 right-3 bg-white rounded-full py-1 px-4 text-xs sm:text-sm">{{ $shops[$i]['tag'] }}</span>
                    </div>
                    <div class="relative">
        ...
        <div class="flex items-center justify-between mb-8">
            <a href="" class="inline-flex items-center">
                <h1 class="p-1 sm:p-2 font-clash font-medium text-sm sm:text-2xl border-b-2 border-black">Barbershop</h1>
                <svg class="stroke-black stroke-1 size-4 sm:size-6" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7 17L17 7M17 7H9M17 7V15"  stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </a>
            <div class="inline-flex items-center gap-2">
                <button id="left-arrow2" class="inline-flex justify-center items-center">
                    <svg class="bg-white p-1 stroke-black stroke-2 size-6 sm:size-8 rounded-full shadow-md hover:shadow-md hover:scale-110 transition-transform duration-300 ease-in-out" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17 12H7M7 12L11 16M7 12L11 8" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </button>
                <button id="right-arrow2" class="inline-flex justify-center items-center">
                    <svg class="bg-white p-1 stroke-black stroke-2 size-6 sm:size-8 rounded-full shadow-md hover:scale-110 transition-transform duration-300 ease-in-out" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7 12H17M17 12L13 8M17 12L13 16" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </button>
        ...
        <div id="carousel2" class="carousel overflow-x-hidden whitespace-nowrap snap-x mb-10">
            ...
            <a href="" id="shop-card" class="w-[21rem] sm:w-[25.1rem] inline-block mr-6 mb-8">
                <div class="relative mb-2">
                    <img load="lazy" class="h-[13rem] sm:h-[15rem] w-full object-cover rounded-lg" src="{{ asset('assets/images/shops/' . $shops[$i]['image'] ) }}" alt="">
                    <span class="absolute top-3 right-3 bg-white rounded-full py-1 px-4 text-xs sm:text-sm">{{ $shops[0]['tag'] }}</span>
                </div>
                <div class="relative">
                    <h6 class="font-semibold text-sm sm:text-base">{{ $shops[$i]['name'] }}</h6>
                    <p class="opacity-60 text-xs sm:text-sm">Street Name, Barangay, City</p>
        ...
        <div class="flex items-center justify-between mb-8">
            <a href="" class="inline-flex items-center">
                <h1 class="p-1 sm:p-2 font-clash font-medium text-sm sm:text-2xl border-b-2 border-black">Beauty Salon</h1>
                <svg class="stroke-black stroke-1 size-4 sm:size-6" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7 17L17 7M17 7H9M17 7V15"  stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </a>
            <div class="inline-flex items-center gap-2">
                <button id="left-arrow3" class="inline-flex justify-center items-center">
                    <svg class="bg-white p-1 stroke-black stroke-2 size-6 sm:size-8 rounded-full shadow-md hover:shadow-md hover:scale-110 transition-transform duration-300 ease-in-out" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17 12H7M7 12L11 16M7 12L11 8" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </button>
                <button id="right-arrow3" class="inline-flex justify-center items-center">
                    <svg class="bg-white p-1 stroke-black stroke-2 size-6 sm:size-8 rounded-full shadow-md hover:scale-110 transition-transform duration-300 ease-in-out" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7 12H17M17 12L13 8M17 12L13 16" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </button>
        ...
        <div id="carousel3" class="carousel overflow-x-hidden whitespace-nowrap snap-x mb-10">
            ...
            <a href="" id="shop-card" class="w-[21rem] sm:w-[25.1rem] inline-block mr-6 mb-8">
                <div class="relative mb-2">
                    <img load="lazy" class="h-[13rem] sm:h-[15rem] w-full object-cover rounded-lg" src="{{ asset('assets/images/shops/' . $shops[$i]['image'] ) }}" alt="">
                    <span class="absolute top-3 right-3 bg-white rounded-full py-1 px-4 text-xs sm:text-sm">{{ $shops[1]['tag'] }}</span>
                </div>
                <div class="relative">
                    <h6 class="font-semibold text-sm sm:text-base">{{ $shops[$i]['name'] }}</h6>
                    <p class="opacity-60 text-xs sm:text-sm">Street Name, Barangay, City</p>
        ...
        <div class="flex items-center justify-between mb-8">
            <a href="" class="inline-flex items-center">
                <h1 class="p-1 sm:p-2 font-clash font-medium text-sm sm:text-2xl border-b-2 border-black">Nail Salon</h1>
                <svg class="stroke-black stroke-1 size-4 sm:size-6" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7 17L17 7M17 7H9M17 7V15"  stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </a>
            <div class="inline-flex items-center gap-2">
                <button id="left-arrow4" class="inline-flex justify-center items-center">
                    <svg class="bg-white p-1 stroke-black stroke-2 size-6 sm:size-8 rounded-full shadow-md hover:shadow-md hover:scale-110 transition-transform duration-300 ease-in-out" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17 12H7M7 12L11 16M7 12L11 8" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </button>
                <button id="right-arrow4" class="inline-flex justify-center items-center">
                    <svg class="bg-white p-1 stroke-black stroke-2 size-6 sm:size-8 rounded-full shadow-md hover:scale-110 transition-transform duration-300 ease-in-out" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7 12H17M17 12L13 8M17 12L13 16" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </button>
        ...
        <div id="carousel4" class="carousel overflow-x-hidden whitespace-nowrap snap-x mb-10">
            ...
            <a href="" id="shop-card" class="w-[21rem] sm:w-[25.1rem] inline-block mr-6 mb-8">
                <div class="relative mb-2">
                    <img load="lazy" class="h-[13rem] sm:h-[15rem] w-full object-cover rounded-lg" src="{{ asset('assets/images/shops/' . $shops[$i]['image'] ) }}" alt="">
                    <span class="absolute top-3 right-3 bg-white rounded-full py-1 px-4 text-xs sm:text-sm">{{ $shops[3]['tag'] }}</span>
                </div>
                <div class="relative">
                    <h6 class="font-semibold text-sm sm:text-base">{{ $shops[$i]['name'] }}</h6>
                    <p class="opacity-60 text-xs sm:text-sm">Street Name, Barangay, City</p>
        ...
        <div class="flex items-center justify-between mb-8">
            <a href="" class="inline-flex items-center">
                <h1 class="p-1 sm:p-2 font-clash font-medium text-sm sm:text-2xl border-b-2 border-black">Hair Salon</h1>
                <svg class="stroke-black stroke-1 size-4 sm:size-6" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7 17L17 7M17 7H9M17 7V15"  stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </a>
            <div class="inline-flex items-center gap-2">
                <button id="left-arrow5" class="inline-flex justify-center items-center">
                    <svg class="bg-white p-1 stroke-black stroke-2 size-6 sm:size-8 rounded-full shadow-md hover:shadow-md hover:scale-110 transition-transform duration-300 ease-in-out" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17 12H7M7 12L11 16M7 12L11 8" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </button>
                <button id="right-arrow5" class="inline-flex justify-center items-center">
                    <svg class="bg-white p-1 stroke-black stroke-2 size-6 sm:size-8 rounded-full shadow-md hover:scale-110 transition-transform duration-300 ease-in-out" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7 12H17M17 12L13 8M17 12L13 16" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </button>
