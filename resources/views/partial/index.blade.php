...
<div class="content-section 
    ...
    <div class="flex mb-20 gap-10">
        ...
        <div class="flex-1 pt-20 ">
            ...
            <div class="flex flex-col items-center justify-center lg:block">
                <h1 class="font-clash font-medium text-[2.5rem] leading-10 sm:text-5xl lg:text-6xl max-w-[37rem] text-pretty mb-4 text-center lg:text-left">Transformation in a click of a button </h1>
                <p class=" text-pretty max-w-[37rem] mb-6 text-center lg:text-left">A comprehensive booking platform for beauty-related services offering its users ease and comfort.</p>
            </div>
            {{-- Buttons --}}
            <div class="grid grid-cols-3 lg:flex mt-4 gap-4 items-center xl:max-w-[40rem]">
                <form action="" class="col-span-2 relative inline-flex items-center lg:flex-1">
                    @csrf
                    <input type="text" class="w-full text-xs sm:text-sm lg:text-base lg:min-w-[21rem] h-12 lg:h-16 pl-6 pr-10 lg:pr-16 rounded-full shadow-lg " placeholder="Search for services near you">
                    <svg class="fill-white bg-black rounded-full absolute right-3 lg:right-6 cursor-pointer size-7 lg:size-10" width="34" height="35" viewBox="0 0 34 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a id="get-started-btn" class="col-span-1 rounded-full nav-link lg:flex-1" href="{{ route('explore') }}" data-url="{{ route('explore.content') }}">
                    <button class="text-nowrap text-xs sm:text-sm lg:text-base px-6 h-12 lg:h-16 w-full lg:w-[17rem] rounded-full bg-brand-500 hover:bg-brand-600 active:bg-brand-400 text-white">Get Started</button>
                </a>
            </div>
        </div>
        {{-- Image Section --}}
        <div class="hidden xl:block xl:mt-20 2xl:mt-0">
            <img class="h-auto max-h-[30rem] aspect-square lazyload" src="{{ asset('assets/images/landingpageVector.png') }}" alt="">
        </div>
    </div>

    <div class="flex items-center justify-between mb-8">
        <h1 class="p-2 font-clash font-medium sm:text-2xl border-b-2 border-black">Customer's Choice</h1>
        <a href="" class="inline-flex items-center gap-2 p-2 border-b-2 border-neutral-400">
            ...
            <span class="font-clash text-sm sm:text-lg font-medium text-neutral-500">See More</span>
        </a>
    </div>
    <div class="grid 
    ...
    <div class="mb-8 min-w-min">
        <h1 class="p-2 font-clash font-medium sm:text-2xl border-b-2 border-black w-min text-nowrap">How it works...</h1>
    </div>

    <div class="grid lg:grid-cols-2 gap-6">
        <div class="bg-white px-10 py-8 sm:py-16 rounded-2xl sm:rounded-[3rem] relative overflow-hidden flex flex-col justify-center">
            <h1 class="font-semibold mb-4 text-sm sm:text-base z-20 relative">Service Selection</h1>
            <p class="text-pretty text-xs sm:text-sm z-20 relative">A huge selection of services categorized to make it easier for users to find what suits their needs.</p>
        ...
        <div class="bg-white px-10 py-8 sm:py-16 rounded-2xl sm:rounded-[3rem] relative overflow-hidden flex flex-col justify-center">
            ...
            <p class="text-pretty text-xs sm:text-sm z-20 relative">A built-in feature to manage your appointments on the go. </p>
        ...
        <div class="bg-white px-10 py-8 sm:py-16 rounded-2xl sm:rounded-[3rem] relative overflow-hidden flex flex-col justify-center">
            ...
            <p class="text-pretty text-xs sm:text-sm z-20 relative">From shop services to shop galleries, how you customize and set up your shop is all up to you!</p>
        ...
        <div class="bg-white px-10 py-8 sm:py-16 rounded-2xl sm:rounded-[3rem] relative overflow-hidden flex flex-col justify-center">
            ...
            <p class="text-pretty text-xs sm:text-sm z-20 relative">Automated notifications for upcoming appointments.</p>
