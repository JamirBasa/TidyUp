            ...
            <form method="" action="">
                ...
                <div class="grid grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <div class="py-2 px-4 text-xs space-y-8">
                            <div class="flex items-center ">
                                <input id="all-categories" type="checkbox" value=""
                                    class="w-4 h-4 text-brand-600 accent-brand-400 bg-gray-100 border-gray-300 rounded focus:ring-brand-500 dark:focus:ring-brand-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                    name="all-categories">
                                <label for="all-categories"
                                    class="ms-2 text-xs font-medium text-gray-900 dark:text-gray-300">All
                                    Categories</label>
                            </div>
                            <div class="flex items-center">
                                <input id="barbershops" type="checkbox" value="Barbershop"
                                    class="w-4 h-4 text-brand-600 accent-brand-400 bg-gray-100 border-gray-300 rounded focus:ring-brand-500 dark:focus:ring-brand-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                    name="barbershops">
                                <label for="barbershops"
                                    class="ms-2 text-xs font-medium text-gray-900 dark:text-gray-300">Barbershop</label>
                            </div>
                            <div class="flex items-center">
                                <input id="beauty-salons" type="checkbox" value="Beauty Salons"
                                    class="w-4 h-4 text-brand-600 accent-brand-400 bg-gray-100 border-gray-300 rounded focus:ring-brand-500 dark:focus:ring-brand-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                    name="beauty-salons">

                                <label for="beauty-salons"
                                    class="ms-2 text-xs font-medium text-gray-900 dark:text-gray-300">Beauty
                                    Salons</label>
                            </div>

                            <div class="flex items-center">

                                <input id="nail-salons" type="checkbox" value="Nail Salons"
                                    class="w-4 h-4 text-brand-600 accent-brand-400 bg-gray-100 border-gray-300 rounded focus:ring-brand-500 dark:focus:ring-brand-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                    name="nail-salons">

                                <label for="nail-salons"
                                    class="ms-2 text-xs font-medium text-gray-900 dark:text-gray-300">Nail
                                    Salons</label>
                    ...
                    <div>
                        ...
                        <div class="py-2 px-4 text-xs space-y-8">
                            ...
                            <div class="flex items-center">
                                <input checked id="availability-2" type="radio" value="available"
                                    name="availability"
                                    class="w-4 h-4 text-brand-600 accent-brand-400  bg-gray-100 border-gray-300 focus:ring-brand-500 dark:focus:ring-brand-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
