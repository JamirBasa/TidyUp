    ...
    <div class="content-section">
        ...
        <div class="flex flex-col col-span-1 bg-white rounded-lg h-min shadow-md p-6 gap-4 sticky top-32">
            ...
            <div class="flex flex-col items-start mb-1">
                ...
                <div class=" text-brand-300 mb-2">{{ $currentBranch->availability }}</div>
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                document.addEventListener('click', function(event) {
                                    if (!branchChangeBtn.contains(event.target) && !branchDropdown.contains(event.target)) {
                                ...
                                branchDropdown.querySelectorAll('div').forEach(option => {
                                    option.addEventListener('click', function() {
                                        // Update button text
                                        branchChangeBtn.querySelector('svg').parentElement.previousElementSibling
